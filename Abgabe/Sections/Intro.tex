...
First we want to show what the actual goal of congestion control is which we will show in Section \ref{sec:Goal}.
After this and to establish a foundational understanding, Section \ref{sec:Background} presents the necessary theoretical background and a common metric to measure \ac{CCA}. 
...
In Section \ref{sec:Approach}, we survey recent advancements in the field, specifically focusing on \ac{BBR} and Copa, alongside both of their extensions. 
