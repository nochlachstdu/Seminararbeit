...
Copa+ utilizes this supplemental parameter to prevent erroneous transitions into competitive mode, a claim supported by Jiang et al. experimental results. 
...
However, as Jiang et al. do not provide specific throughput statistics, a definitive conclusion regarding its impact on link utilization cannot be reached.
